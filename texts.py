...
TEXTS = {
    "ru": {
        ...
        "morning_digest_empty_weekly": "☀️ *Доброе утро!* На этой неделе задач пока нет.\n\nКстати, задачи можно надиктовать голосом 🎙 — скажи, что нужно сделать, и я создам задачу и поставлю напоминание.",
    ...
    "en": {
        ...
        "morning_digest_empty_weekly": "☀️ *Good morning!* No tasks scheduled this week yet.\n\nBy the way — you can dictate tasks by voice 🎙 Just say what needs doing and I'll create the task and set a reminder.",
    ...
    "uk": {
        ...
        "morning_digest_empty_weekly": "☀️ *Доброго ранку!* На цьому тижні задач поки немає.\n\nДо речі, задачі можна надиктувати голосом 🎙 — скажи, що треба зробити, і я створю задачу та поставлю нагадування.",
