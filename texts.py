...
TEXTS = {
    "ru": {
        ...
        "cal_sync_new": "📅 Новое событие из Google Calendar добавлено в твои задачи:\n*{title}*\n🗓 {date}",
        "cal_sync_removed": "🗑 Событие удалено из Google Calendar — убрано из задач:\n*{title}*",
    ...
    "en": {
        ...
        "cal_sync_new": "📅 New event from Google Calendar added to your tasks:\n*{title}*\n🗓 {date}",
        "cal_sync_removed": "🗑 Event removed from Google Calendar — deleted from tasks:\n*{title}*",
    ...
    "uk": {
        ...
        "cal_sync_new": "📅 Нова подія з Google Calendar додана до твоїх задач:\n*{title}*\n🗓 {date}",
        "cal_sync_removed": "🗑 Подію видалено з Google Calendar — прибрано із задач:\n*{title}*",
