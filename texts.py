...
TEXTS = {
    "ru": {
        ...
        "cal_sync_new": "📅 Обновлено из календаря:\n*{title}*\n{date}",
        "cal_sync_removed": "🗑 Удалено из календаря: *{title}*",
        ...
        "saved_with_calendar": "✅ Сохранено в задачах и Google Календаре",
        ...
        "reschedule_nothing_upcoming": "⚠️ Пока нечего переносить — предстоящих задач нет.",
        ...
        "delete_choose": "🗑 *Удаление задач*\n\nВыбери задачу, которую нужно удалить:",
        "delete_none": "Нет задач для удаления.",
        ...
        "reengagement": [
            ...
            "Маленький шаг сегодня — большой результат через месяц 🚀\n\nЗапланируй одну задачу прямо сейчас.",
            "Голова — не место для хранения дел 🧠\n\nВыгрузи всё, что вертится в мыслях, — я разложу по полочкам.",
            "Лучшее время начать — сейчас ⏰\n\nНапиши или надиктуй задачу, и я напомню вовремя.",
            "Я всё ещё здесь 🙂\n\nКак будешь готов — просто пришли задачу. Ничего не забуду.",
        ],
        "btn_reengage_off": "🔕 Не напоминать",
        "reengage_off_ack": "Хорошо, больше не буду напоминать о задачах 🤝\n\nЗадачи всегда можно добавить — просто напиши или надиктуй.",
    ...
    "en": {
        ...
        "cal_sync_new": "📅 Updated from calendar:\n*{title}*\n{date}",
        "cal_sync_removed": "🗑 Removed from calendar: *{title}*",
        ...
        "saved_with_calendar": "✅ Saved to your tasks and Google Calendar",
        ...
        "reschedule_nothing_upcoming": "⚠️ Nothing to move — you have no upcoming tasks.",
        ...
        "reengagement": [
            ...
            "A small step today — a big result in a month 🚀\n\nPlan just one task right now.",
            "Your head is no place to store to-dos 🧠\n\nDump whatever's on your mind — I'll sort it out.",
            "The best time to start is now ⏰\n\nType or dictate a task and I'll remind you on time.",
            "I'm still here 🙂\n\nWhenever you're ready — just send a task. I won't forget a thing.",
        ],
        "btn_reengage_off": "🔕 Stop reminders",
        "reengage_off_ack": "Got it — I won't send these reminders anymore 🤝\n\nYou can always add a task — just type or dictate it.",
    ...
    "uk": {
        ...
        "cal_sync_new": "📅 Оновлено з календаря:\n*{title}*\n{date}",
        "cal_sync_removed": "🗑 Видалено з календаря: *{title}*",
        ...
        "saved_with_calendar": "✅ Збережено в задачах і Google Календарі",
        ...
        "reschedule_nothing_upcoming": "⚠️ Поки нема чого переносити — майбутніх задач немає.",
        ...
        "btn_delete_task": "🗑 Видалити задачу",
        "delete_choose": "🗑 *Видалення задач*\n\nОбери задачу, яку потрібно видалити:",
        "delete_none": "Немає задач для видалення.",
        "delete_confirm": "Видалити задачу?\n\n🔹 *{title}*\n{date}\n\nЦю дію не можна скасувати.",
        "btn_delete_yes": "🗑 Так, видалити",
        "btn_delete_cancel": "← Скасувати",
        "delete_done": "🗑 Задачу видалено.",
        "btn_back": "← Назад",
        "tasks_item": "{emoji} *{title}* — {date}\n",
        ...
        "reengagement": [
            ...
            "Маленький крок сьогодні — великий результат за місяць 🚀\n\nЗаплануй одну задачу просто зараз.",
            "Голова — не місце для зберігання справ 🧠\n\nВивантаж усе, що крутиться в думках, — я розкладу по поличках.",
            "Найкращий час почати — зараз ⏰\n\nНапиши або надиктуй задачу, і я нагадаю вчасно.",
            "Я все ще тут 🙂\n\nЯк будеш готовий — просто надішли задачу. Нічого не забуду.",
        ],
        "btn_reengage_off": "🔕 Не нагадувати",
        "reengage_off_ack": "Добре, більше не нагадуватиму про задачі 🤝\n\nЗадачі завжди можна додати — просто напиши або надиктуй.",
