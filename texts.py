...
TEXTS = {
    "ru": {
        ...
        "delete_none": "Нет будущих задач для удаления.\n\nУдалять можно только задачи начиная с завтрашнего дня.",
    ...
    "en": {
        ...
        "delete_none": "No future tasks to delete.\n\nOnly tasks from tomorrow onwards can be deleted.",
    ...
    "uk": {
        ...
        "delete_none": "Немає майбутніх задач для видалення.\n\nВидаляти можна лише задачі починаючи із завтрашнього дня.",
